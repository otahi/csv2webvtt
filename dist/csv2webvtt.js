...
export class Csv2Webvtt {
    ...
    output;
    parser;
    timeshift = { sign: '', hours: 0, minutes: 0, seconds: 0, isSet: false };
    readStream;
    writeStream;
    constructor(inputCsv, output, timeshift) {
        ...
        if (typeof timeshift === 'string' && timeshift.length > 0) {
            ...
            const { sign, hours, minutes, seconds, sign2, singleSeconds } = timeshift.match(timeshiftPattern)?.groups;
            this.timeshift = {
                sign: sign || sign2,
    ...
    async convert() {
        ...
        let cue = { speaker: null, start: null, end: null, text: null };
        let nextCue = { speaker: null, start: null, end: null, text: null };
